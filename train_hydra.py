        ...
        metrics.update(
            {
                ...
                "train/aux_heatmap_rank_loss": train_metrics.get("heatmap_rank", 0.0)
                if mode == "aux"
                else train_metrics.get("aux_heatmap_rank", 0.0),
                "train/heatmap_center_collision_rate": train_metrics.get("heatmap_center_collision_rate", 0.0)
                if mode == "aux"
                else train_metrics.get("aux_heatmap_center_collision_rate", 0.0),
...
def _aux_metrics_dict(
    *,
    ...
    metrics = {
        ...
        "val/aux_heatmap_rank_loss": val_metrics.get("heatmap_rank", 0.0),
        "val/heatmap_offset_mae": val_metrics["heatmap_offset_mae"],
        "val/heatmap_center_count": val_metrics.get("heatmap_center_count", 0.0),
        "val/heatmap_center_collision_rate": val_metrics.get("heatmap_center_collision_rate", 0.0),
...
def _joint_metrics_dict(
    *,
    ...
    metrics = {
        ...
        "train/aux_heatmap_rank_loss": train_metrics.get("aux_heatmap_rank", 0.0),
        ...
        "val/aux_heatmap_rank_loss": val_aux_metrics.get("heatmap_rank", 0.0),
        "val/heatmap_offset_mae": val_aux_metrics["heatmap_offset_mae"],
        "val/heatmap_center_count": val_aux_metrics.get("heatmap_center_count", 0.0),
        "val/heatmap_center_collision_rate": val_aux_metrics.get("heatmap_center_collision_rate", 0.0),
